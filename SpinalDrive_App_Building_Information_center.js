...
/**
 * SpinalDrive_App_FileExplorer_building_information_center
 * @extends {SpinalDrive_App}
 */
class SpinalDrive_App_FileExplorer_building_information_center extends SpinalDrive_App {
  /**
   * Creates an instance of SpinalDrive_App_FileExplorer_building_information_center.
   * @memberof SpinalDrive_App_FileExplorer_building_information_center
   */
  constructor() {
    super(
      "OpenBuildingInformationFileExplorer",
      "Open with Building Information Center",
      10,
      "location_city",
      "Open the Building Information Center"
    );
  ...
  action(obj) {
    ...
    let location = "/html/buildingInformation/?path=" + btoa(path);
...
//module.exports.FileExplorerbuilding_informationViewer = SpinalDrive_App_FileExplorer_building_information_center;

window.spinalDrive_Env.add_applications(
  "FileExplorer",
  new SpinalDrive_App_FileExplorer_building_information_center()
);
